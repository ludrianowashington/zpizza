...
export function ProductCard(data: IProduct){
  return(
    <div className="flex  rounded-lg w-full max-w-md p-3 border-stone-600 border-[1px]">
      ...
      <div className="px-2 h-full w-60 border-[1px] rounded-lg pt-1 border-red-600">
        ...
        <div className="flex flex-col py-2 ">
          ...
          <span className="font-normal text-sm ">Descrição dos ingredientes da pizza.</span>
        </div>
        <button className="w-full h-9 rounded-lg bg-green-600 text-white font-bold text-base">PEÇA AGORA</button>
      </div>
    </div>
  )
}